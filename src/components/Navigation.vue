        ...
        <Menubar>
            <template #start>
                <div class="flex flex-row justify-center items-center gap-4">
                    <Button severity="secondary" size="small" variant="outlined" icon="pi pi-bars"
                        @click="visible = true" />
                    <p class="text-2xl font-semibold">Main dashboard</p>
                </div>
            </template>
            <template #end>
                ...
                <template #container="{ closeCallback }">
                    <div class="flex flex-col h-full">
                        <div class="flex items-center justify-between px-6 pt-4 shrink-0">
                            ...
                            <span>
                                <Button type="button" @click="closeCallback" icon="pi pi-times" rounded
                                    variant="outlined" severity="secondary" size="small"></Button>
                            </span>
                        </div>
